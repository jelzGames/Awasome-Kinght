...
public class PlayerAttackEffects : MonoBehaviour {
    ...
    public GameObject groundimpact_Prefab, KickFX_Prefab, fireTornado_Prefab, fireShield_Prefab, healFX_Prefabs, thunderFX_pREFAB;
    ...
    void Heal()
    {
        ...
        temp.y += 2f;
        GameObject healobj = Instantiate(healFX_Prefabs, temp, Quaternion.identity) as GameObject;
